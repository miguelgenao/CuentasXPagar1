...
namespace CuentasXPagar1.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(cuentasporpagarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,TipoPersona,Cedula,Balance,Estado")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,TipoPersona,Cedula,Balance,Estado")] Proveedore proveedore)
        {
            if (id != proveedore.Id)
            {
                return NotFound();
